...
const CENTER_PHOTOS: InteriorPhoto[] = [
  {
    id: "c-i-1",
...
const HIPPODROME_PHOTOS: InteriorPhoto[] = [
  {
    id: "h-i-1",
...
export const DEFAULT_INTERIOR = {
  ...
  centerCoffee: CENTER_PHOTOS.map((p, i) => ({
    ...p,
    id: `cc-i-${i + 1}`,
  })),
  hippodrome: HIPPODROME_PHOTOS,
  hippodromeCoffee: HIPPODROME_PHOTOS.map((p, i) => ({
    ...p,
    id: `hc-i-${i + 1}`,
  })),
};
